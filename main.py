...
is_well_formed_url = re.compile(r'^https?://.+/.+$') #https://example.com/hola
...
def _news_scraper(news_site_uid):
    ...
    for link in homepage.article_links:
        article = __fetch_article(news_site_uid, host, link)
...
def __fetch_article(news_site_uid, host, link):
